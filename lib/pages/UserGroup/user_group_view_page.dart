...
import 'package:tezchal/ui_elements/user_group_view_loading.dart';
...
class _UserGroupViewPageState extends State<UserGroupViewPage> {
  ...
  fetchSpecialRate() async {
    ...
    var response = await netGet(
      isUserToken: true,
      endPoint: "product",
      params: {"page": "1", "limit": "5", "order": "name", "sort": "asc"},
    );
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 15),
                                Text("share", style: normalWhiteText).tr(),
                              ],
                            ),
                          ),
                        ),
