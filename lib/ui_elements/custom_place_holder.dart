...
class CustomContentPlaceholder extends StatelessWidget {
  /// Single block for group of shapes. block should be used only inside a CustomContentPlaceholder.
  static Widget block({
    double? width,
    double? height,
  ...
  Widget build(BuildContext context) {
    if (this.child != null) {
      ...
      return CustomContentPlaceholder(
        bgColor: this.bgColor,
        highlightColor: this.highlightColor,
        isAnimationEnabled: this.isAnimationEnabled,
        child: CustomContentPlaceholder.block(
          width: this.width,
          height: this.height,
